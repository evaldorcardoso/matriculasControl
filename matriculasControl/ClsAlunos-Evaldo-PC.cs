...
namespace matriculasControl
{
    ...
    class ClsAlunos
    {
        ...
        public static IDataAdapter inserir(string nome, int codigo, string data_nasc)
        {
            StringBuilder insert = new StringBuilder();
            insert.Append("insert into alunos");
            insert.Append(" values ('"+codigo+"','"+nome+"','"+data_nasc+"')");
        ...
        public static DataTable pesquisar(string nome)
        {
            ...
            pesquisa.Append("select nome, data_nasc from alunos");
            pesquisa.Append(" where nome LIKE '%" + nome + "%'");
            return clsPostgres.getDataTable(pesquisa.ToString());
        }

        public static IDataAdapter editar(int codigoAnt, int codigo, string nome, string data_nasc)
        {
            StringBuilder edit = new StringBuilder();
            edit.Append("delete from alunos");
            edit.Append(" where id_aluno = "+codigoAnt+";");
            edit.Append("insert into alunos");
            edit.Append(" values ('" + codigo + "','" + nome + "','" + data_nasc + "')");
